...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="text">
        Hello,<br /><br />
        A new principal has been successfully added to the school <strong>“${school_name}”</strong>.<br /><br />
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="text">
        Hello,<br /><br />
        The login password for the principal role of <strong>“${school_name}”</strong> has been updated successfully.<br /><br />
        Please use the following updated login credentials:
      </div>
...
module.exports = { sendOTPToEmail, addSchoolEmail, updateSchoolEmail, addroleEmail, updateRoleEmail, studentRequistAccessept, studentRequistRejected, studentRequistPending };