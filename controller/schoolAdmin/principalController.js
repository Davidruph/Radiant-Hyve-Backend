...
const editPrincipal = async (req, res) => {
  ...
  try {
    ...
    if (!principal) {
      return res
        .status(404)
        .json({ status: 0, message: "Principal not found" });
    }
...
const getPrincipal = async (req, res) => {
  ...
  try {
    ...
    if (!principal_id) {
      return res
        .status(400)
        .json({ status: 0, message: "principal_id is requried" });
    }
    ...
    if (!principal) {
      return res
        .status(404)
        .json({ status: 2, message: "Principal not found" });
    }
...
const deletePrincipal = async (req, res) => {
  ...
  try {
    ...
    if (!principal_id) {
      return res
        .status(400)
        .json({ status: 0, message: "principal_id is required." });
    }
    const principal = await db.User.findOne({
      where: {
        id: principal_id,
