...
exports.addStudentlValidation = () => {
  return [
    [
      ...
      check("relation_to_child")
        .not()
        .isEmpty()
        .withMessage("relation_to_child is required"),
      check("madical_insuarance_no")
        .not()
        .isEmpty()
        .withMessage("madical_insuarance_no is required"),
      ...
      check("gender")
        ...
        .withMessage(
          "Invalid gender, valid gender are: 'male', 'female', 'other'"
        ),
      check("dob")
  ...
  return [
    [
      ...
      check("iso_code")
        ...
        .not()
        .isEmpty()
        .withMessage("iso_code is required"),
      check("address")
        .optional()
        .not()
        .isEmpty()
      ...
      check("mobile_no")
        ...
        .not()
        .isEmpty()
        .withMessage("mobile_no is required"),
      check("relation_to_child")
        .optional()
        .not()
        .isEmpty()
      ...
      check("shift_id")
        ...
        .not()
        .isEmpty()
        .withMessage("shift_id is required"),
      check("gender")
        .optional()
        .not()
        .isEmpty()
  ...
  return [
    [
      ...
      check("type")
        ...
        .isIn(["medication", "sleeplog", "menu"])
        .withMessage(
          "Invalid type, valid type are: 'medication', 'sleeplog', 'menu'"
        )
    ],
    validation
  ];
