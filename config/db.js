...
db.StudentAttendance = require("../model/studentAttendance")(
  sequelize,
  Sequelize,
  Model
);
...
db.MessageStatus = require("../model/messageStatus")(
  sequelize,
  Sequelize,
  Model
);
db.MenuDay = require("../model/menuDay")(sequelize, Sequelize, Model);
db.MedicationInfo = require("../model/medicationInfo")(
  sequelize,
  Sequelize,
  Model
);
db.Certification = require("../model/certification")(
  sequelize,
  Sequelize,
  Model
);
...
db.User.hasMany(db.MessageStatus, {
  foreignKey: "message_by",
  as: "MessageStatuse"
});
...
db.Chat.hasMany(db.MessageStatus, {
  foreignKey: "chat_id",
  as: "ChatMessageStatus"
});
db.MessageStatus.belongsTo(db.Chat, { foreignKey: "chat_id", as: "Chat" });

db.Message.hasMany(db.MessageStatus, {
  foreignKey: "message_id",
  as: "MessageStatus"
});
db.MessageStatus.belongsTo(db.Message, {
  foreignKey: "message_id",
  as: "Message"
});
...
db.User.hasMany(db.Certification, {
  foreignKey: "school_id",
  as: "schoolCertification"
});
db.Certification.belongsTo(db.User, {
  foreignKey: "school_id",
  as: "schoolCertificats"
});
...
db.User.hasMany(db.MedicationInfo, {
  foreignKey: "admin_id",
  as: "adminMedicalInfo"
});
db.MedicationInfo.belongsTo(db.User, {
  foreignKey: "admin_id",
  as: "adminMedicationInfo"
});

db.User.hasMany(db.MedicationInfo, {
  foreignKey: "school_id",
  as: "schoolMedicationInfo"
});
db.MedicationInfo.belongsTo(db.User, {
  foreignKey: "school_id",
  as: "Medication"
...
db.Student.hasMany(db.MedicationInfo, {
  foreignKey: "student_id",
  as: "studentMedicalInfo"
});
db.MedicationInfo.belongsTo(db.Student, {
  foreignKey: "student_id",
...
db.SleepLoag.belongsTo(db.Student, {
  foreignKey: "student_id",
  as: "studentSleepLoag"
});
...
db.User.hasMany(db.StudentAttendance, {
  foreignKey: "teacher_id",
  as: "studentAttendance"
});
db.StudentAttendance.belongsTo(db.User, {
  foreignKey: "teacher_id",
  as: "Attendance"
});

db.Student.hasMany(db.StudentMenu, {
  foreignKey: "student_id",
  as: "StudentMenu"
});
...
db.Route.hasOne(db.DriverLocation, {
  foreignKey: "route_id",
  as: "liveLocation"
});
db.DriverLocation.belongsTo(db.Route, { foreignKey: "route_id", as: "route" });

db.User.hasMany(db.DriverLocation, {
  foreignKey: "driver_id",
  as: "liveLocations"
});
